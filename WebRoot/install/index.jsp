...
版权所有(C) 2012-2013 MUSHROOM保留所有权利。<br />
为了保证您和他人的利益请遵循以下几条使用规则：<br />
1、您可以完全遵循本协议的情况下，将本软件用于商业用途，而不必支付软件的使用费用，但我们也不承诺对非赞助用户提供任何形式的技术支持与帮助。<br />
2、使用本程序您可以不用在明显页面保留程序版权信息，但程序最终版权贵原作者所有，为了程序能持续发展建议您在网站底部注明：powered by mushroomcms.net ，另外我们可能不会对不保留版权信息的用户提供帮助。<br />
3、您可以免费使用本软件，但是禁止对软件进行改名发布，禁止以任何形式对MUSHROOM形成竞争。<br />
...
<script>
function no(){
	alert('感谢您对MUSHROOM的支持！\n作者邮箱: wuweiit@gmail.com');
	window.close();
}
</script>